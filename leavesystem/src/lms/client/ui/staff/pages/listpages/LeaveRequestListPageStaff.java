package lms.client.ui.staff.pages.listpages;
...
public class LeaveRequestListPageStaff extends Composite {
	...
	public LeaveRequestListPageStaff() {
        ...
        userServ.getAuthenticatedUser(new AsyncCallback<User>() {
			...
			public void onSuccess(User result) {
				...
				reqServ.getRequestsByUserId(loggedInUser.getUserId(), new AsyncCallback<List<LeaveRequest>>() {
